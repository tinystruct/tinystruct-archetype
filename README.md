...
*A simple way to bootstrap applications with tinystruct 1.7.22*
...
### **3. Built for tinystruct 1.7.22**
Select the version you want (e.g., `1.7.22`), and it's applied automatically.
...
```cmd
mvn archetype:generate -DarchetypeGroupId="org.tinystruct" -DarchetypeArtifactId="tinystruct-archetype" -DarchetypeVersion="1.0.6" -DgroupId="com.mycompany" -DartifactId="my-tiny-app" -Dpackage="com.mycompany.app" -DtinystructVersion="1.7.22" -DinteractiveMode="false"
```
